...
For accepted pilot status, materialized files, simulator preview state, and next actions, see `documentation/tfy-stack-realignment/teamfoundry-stack-realignment-plan.md`.
